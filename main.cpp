...
int main()
{
    ...
    std::cout << ((W_1.CalcDeterminant() - W_1.MinorsMethod()) < eps) << std::endl;
    std::cout << ((W_2.CalcDeterminant() - W_2.MinorsMethod()) < eps) << std::endl;
    std::cout << ((W_3.CalcDeterminant() - W_3.MinorsMethod()) < eps) << std::endl;
    std::cout << ((W_4.CalcDeterminant() - W_4.MinorsMethod()) < eps) << std::endl;
    std::cout << "@@@@@@@@@@@@@@@@@@@@@@@" << std::endl;
